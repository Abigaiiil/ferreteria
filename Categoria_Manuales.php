...
$stmt = $pdo->prepare("SELECT * FROM productos WHERE categoria = 'manuales' ORDER BY nombre");
$stmt->execute();
...
<head>
    ...
    <title>Herramienta Manual - Gorilla Tools</title>
    ...
    <style>
        ...
        .product-checkbox { position: absolute; top: 12px; right: 12px; width: 20px; height: 20px; accent-color: var(--naranja-fix); }
...
<main class="container my-4">
    <div class="breadcrumb-custom">
        <a href="index.php">Inicio</a> / <a href="#">Herramientas Manuales</a>
    </div>
    <div class="category-header">
        <h1 class="category-title">Herramientas Manuales <span class="product-count" id="productCount"></span></h1>
    </div>
...
seguridaaaaaaaaaaaaaaaaaaa
<?php
session_start();
require_once 'conexion.php';

$stmt = $pdo->prepare("SELECT * FROM productos WHERE categoria = 'seguridad' ORDER BY nombre");
$stmt->execute();
$productos = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Seguridad Industrial - Gorilla Tools</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        :root { --azul-navy: #003d71; --naranja-fix: #f47920; --gris-fondo: #f8f9fa; --gris-borde: #e9ecef; }
...
<main class="container my-4">
    <div class="breadcrumb-custom">
        <a href="index.php">Inicio</a> / <a href="#">Seguridad</a>
    </div>
    <div class="category-header">
        <h1 class="category-title">Productos de Seguridad <span class="product-count" id="productCount"></span></h1>
    </div>
    <div class="filters-bar">
        <div>
            <label>Mostrar:</label>
...
// Obtener productos
$stmt = $pdo->prepare("SELECT * FROM productos WHERE categoria IN ('pintura', 'adhesivos') ORDER BY nombre");
$stmt->execute();
$productos = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pintura y Adhesivos - Gorilla Tools</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        :root {
        ...
        .btn-cotizar-seleccion:hover {
            background: var(--naranja-fix);
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="input-group search-bar">
                    ...
                    <button class="btn btn-light" id="btnBuscar">
...
<main class="container my-4">
    <div class="breadcrumb-custom">
        <a href="index.php">Inicio</a> / <a href="#">Pinturas</a>
    </div>
    <div class="category-header">
        <h1 class="category-title">Productos de Pinturas <span class="product-count" id="productCount"></span></h1>
    </div>
    <div class="filters-bar">
        <div>
            <label>Mostrar:</label>
    ...
    <div style="max-width: 1200px; margin: 0 auto;">
        <div class="row">
            <div class="col-md-3">
                ...
                <p style="font-size: 14px; opacity: 0.8;">Tu ferretería de confianza con las mejores herramientas.</p>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <h4 style="color: #f47920; font-size: 18px;">Contacto</h4>
                <ul class="list-unstyled">
                    <li><i class="bi bi-telephone-fill me-2"></i> 868 455 9524</li>
                    <li><i class="bi bi-envelope-fill me-2"></i> comprasonline@gorillatools.com</li>
                    <li><i class="bi bi-geo-alt-fill me-2"></i> Matamoros / Reynosa, Tamps.</li>
                </ul>
            </div>
            <div class="col-md-3">
                <h4 style="color: #f47920; font-size: 18px;">Horarios</h4>
                <ul class="list-unstyled">
