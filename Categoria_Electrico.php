...
$stmt = $pdo->prepare("SELECT * FROM productos WHERE categoria = 'electricos' ORDER BY nombre");
$stmt->execute();
...
<head>
    ...
    <title>Productos Eléctricos - Gorilla Tools</title>
...
<main class="container my-4">
    <div class="breadcrumb-custom">
        <a href="index.php">Inicio</a> / <a href="#">Eléctricos</a>
    </div>
    <div class="category-header">
        <h1 class="category-title">Productos Eléctricos <span class="product-count" id="productCount"></span></h1>
    </div>
